...
--
CREATE DATABASE mburnaevg4_fulls CHARACTER SET utf8 COLLATE utf8_general_ci;
USE mburnaevg4_fulls;
-- --------------------------------------------------------
...
INSERT INTO `products` (`id`, `skidka`, `description`, `price`, `imgsrc`) VALUES
(1, '50%', 'на звонки ST' , 5, '/assets/phone.png'),
(2, '30%', 'за спецкурс' , 10, '/assets/book.png'),
(3, '50%', 'за курс' , 20, '/assets/folder.png'),
(4, '65%', 'за курс' , 25, '/assets/folder.png');
